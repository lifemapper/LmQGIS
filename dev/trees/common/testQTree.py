...
class myModel(QAbstractItemModel):
    ...
    def __init__(self, parent=None):
        ...
        # Create items
        self.root = myNode('root', None)
       
        itemA = myNode('itemA',  self.root)
        itemA1 = myNode('itemA1',  itemA)

        itemB = myNode('itemB',  self.root)
        itemB1 = myNode('itemB1', itemB)
       
        itemC = myNode('itemC',  self.root)
        itemC1 = myNode('itemC1',  itemC)
