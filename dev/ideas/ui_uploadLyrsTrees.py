...
class Ui_Dialog(object):
   ...
   def setupUi(self, experimentname=''):
      ...
      self.convertButton = QtGui.QPushButton("upload/convert")
   ...
   def setAllPopUp(self,pos):
      ...
      try:
         ...
         if index.column() != 0:
            ...
            menu = QMenu()
            pathAction = menu.addAction('Find lyr for this species')
            action = menu.exec_(QCursor.pos())
   ...
   def showFileDialog(self):
      ...
      dirName = str(settings.value( "/UI/lastShapefileDir" ).toString())
