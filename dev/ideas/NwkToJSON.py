...
#nexusTreeMod = "((A,B,(C,D)E)F);"      
#      
#      
#t = open('/home/jcavner/PhyloXM_Examples/amphibiansFromNexus.nhx','r').read()
t = open('/home/jcavner/PhyloXM_Examples/newick.nhx','r').read()
##t = nexusTreeMod
sh = Parser.from_string(t) #nexusTreeMod- for bats, works
p = Parser(sh)
phyloDict,parentDicts = p.parse()
#
#
#
with open('/home/jcavner/PhyloXM_Examples/newickFromPooka1.json','w') as f:
